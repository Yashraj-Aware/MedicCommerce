...
import { addToWishlist } from "../../Profile/WishlistSlice";
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-1 lg:grid-cols-3 xl:gap-x-8">
              {data?.isLoading ? (
                ...
                data?.data.map((product) => (
                  <div
                    key={product._id}
                    className="group relative border-solod border-2 p-2       "
                  >
                      ...
                      <div>
                        <h3 className="text-sm text-gray-700">
                          ...
                          <ReactStars
                            ...
                            color1={"#ffc107"}
                          />
                          <p className="text-lg py-2 font-medium text-gray-900">
                            {product.name}
                          </p>

                          <p className="px-5 pb-2 text-base font-medium text-emerald-600">
                            ₹{product.price}
                          </p>
                          <div className=" flex items-center justify-center overflow-hidden transition-all group-hover:overflow-visible">
                            ...
                            <button
                              ...
                              className="shadow-2xl  mx-1 text-white py-3 px-2 rounded-md transition-all transform translate-y-[-100%] opacity-0 group-hover:opacity-100 group-hover:translate-y-0 hover: bg-emerald-600  "
                            >
                              Wishlist
                            </button>
                            <button
