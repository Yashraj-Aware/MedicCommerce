      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl ">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-12 pt-24 bg-[#c7dde8]">
            <h1 className="sm:text-4xl lg:text-4xl ml-7 mb-7 font-bold tracking-tight text-gray-900 ">Shop</h1>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                {/* {data && data.data.map((section) => (
                  <Disclosure as="div" key={section.catId} className="border-b border-gray-200 py-6">
